# BeemStream FrontendV2

This project will allow BeemStream to have a frontend.
...
Libraries are sharable across libraries and applications. They can be imported from `@frontend-v2/mylib`.
